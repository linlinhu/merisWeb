...
public interface EcmApiFeign {
	...
	@RequestMapping(value = "/api-ecm/ecm/findEcmByIds",method = RequestMethod.GET)
	...
	JSONObject save(@RequestParam(value="ecmStr") String ecmStr);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/api-ecm/ecm/disable",method = RequestMethod.POST)
	 ...
	 * @return
	 */
	@RequestMapping(value = "/api-ecm/ecm/activate",method = RequestMethod.POST)
	...
	@RequestMapping(value = "/api-ecm/ecm/deleteEcmById",method = RequestMethod.POST)
